      ...
      <body className="min-h-screen">
        <Providers>
          <header className="border-b border-edge bg-bg/80 backdrop-blur sticky top-0 z-10">
            <div className="max-w-6xl mx-auto px-4 md:px-6 py-3 md:py-4 flex flex-col md:flex-row md:items-center md:justify-between gap-3 md:gap-0">
              <div className="flex items-center justify-between md:gap-6 md:justify-start">
                <Link href="/" className="font-semibold tracking-tight text-ink whitespace-nowrap">
              ...
              <nav className="flex md:hidden items-center gap-4 text-sm text-muted overflow-x-auto whitespace-nowrap -mx-4 px-4 scrollbar-none">
                <Link href="/buyers" className="hover:text-ink">Buyers</Link>
                <Link href="/holders" className="hover:text-ink">Holders</Link>
                <Link href="/channels" className="hover:text-ink">Channels</Link>
                <Link href="/services" className="hover:text-ink">Services</Link>
